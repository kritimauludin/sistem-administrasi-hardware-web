...
$UbahDataTrxPengadaanHardware = Query("SELECT trx_pengadaan_hardware.kode_pengadaan_hardware, trx_pengadaan_hardware.tanggal_pengadaan_hardware, mst_cabang.kode_cabang, mst_cabang.nama_cabang, mst_divisi.kode_divisi, mst_divisi.nama_divisi, mst_posession.kode_posession, mst_posession.nama_posession, mst_hardware.kode_hardware, mst_hardware.nama_hardware, trx_pengadaan_hardware.serial_number, trx_pengadaan_hardware.keterangan, mst_vendor.kode_vendor, mst_vendor.nama_vendor, trx_pengadaan_hardware.status, trx_pengadaan_hardware.harga_hardware
	...
	WHERE kode_pengadaan_hardware = '$KodePengadaan'")[0];

if (isset($_POST["TombolUbah"])) {
	if (UbahDataTrxPengadaanHardware($_POST) > 0) {
		echo "
			<script>
...
<div class="container">
	<div id="JudulForm">
		<h2>Ubah Data Pengadaan Hardware</h2>
		<hr>
	</div>
</div>
...
<div class="container">
	<form action="" method="POST" id="FormEntri">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="KodePengadaan" name="kode_pengadaan_hardware" value="<?php echo $UbahDataTrxPengadaanHardware["kode_pengadaan_hardware"]; ?>" readonly/>
			</div>
		</div>
		<div class="form-group row Tanggal">
			<label for="TanggalPengadaan" class="col-sm-2 col-form-label">Tanggal Pengadaan</label>
			<div class="input-group col-sm-4">
				<input type="text" class="form-control datepicker" id="TanggalPengadaan" name="tanggal_pengadaan_hardware" value="<?php echo $UbahDataTrxPengadaanHardware["tanggal_pengadaan_hardware"]; ?>" autocomplete="off" required oninvalid="this.setCustomValidity('Tanggal Pengadaan Harus Diisi.')" oninput="setCustomValidity('')"/>
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<input type="hidden" class="form-control" id="KodeCabang" name="kode_cabang" value="<?php echo $UbahDataTrxPengadaanHardware["kode_cabang"]; ?>"/>
				<input type="text" class="form-control" id="NamaCabang" name="nama_cabang" placeholder="Nama Cabang" value="<?php echo $UbahDataTrxPengadaanHardware["nama_cabang"]; ?>" readonly/>
			</div>
			<div class="col-sm-1">
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<input type="hidden" class="form-control" id="KodeDivisi" name="kode_divisi" value="<?php echo $UbahDataTrxPengadaanHardware["kode_divisi"]; ?>"/>
				<input type="text" class="form-control" id="NamaDivisi" name="nama_divisi" placeholder="Nama Divisi" value="<?php echo $UbahDataTrxPengadaanHardware["nama_divisi"]; ?>" readonly/>
			</div>
			<div class="col-sm-1">
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<input type="hidden" class="form-control" id="KodePosession" name="kode_posession" value="<?php echo $UbahDataTrxPengadaanHardware["kode_posession"]; ?>"/>
				<input type="text" class="form-control" id="NamaPosession" name="nama_posession" placeholder="Nama Posession" value="<?php echo $UbahDataTrxPengadaanHardware["nama_posession"]; ?>" readonly/>
			</div>
			<div class="col-sm-1">
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<input type="hidden" class="form-control" id="KodeHardware" name="kode_hardware" value="<?php echo $UbahDataTrxPengadaanHardware["kode_hardware"]; ?>"/>
				<input type="text" class="form-control" id="NamaHardware" name="nama_hardware" placeholder="Nama Hardware" value="<?php echo $UbahDataTrxPengadaanHardware["nama_hardware"]; ?>" readonly/>
			</div>
			<div class="col-sm-1">
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="SerialNumber" name="serial_number" placeholder="Masukan Serial Number Hardware" autocomplete="off" maxlength="30" required oninvalid="this.setCustomValidity('Serial Number Harus Diisi.')" oninput="setCustomValidity('')" value="<?php echo $UbahDataTrxPengadaanHardware["serial_number"]; ?>">
			</div>
		</div>
		<div class="form-group row">
			<label for="Keterangan" class="col-sm-2 col-form-label">Keterangan</label>
			<div class="col-sm-4">
				<textarea class="form-control" name="keterangan" id="Keterangan" cols="50" rows="4" maxlength="200" required oninvalid="this.setCustomValidity('Keterangan Harus Diisi.')" oninput="setCustomValidity('')"><?php echo $UbahDataTrxPengadaanHardware["keterangan"]; ?></textarea>
			</div>
		</div>
		<div class="form-group row">
			<label for="NamaVendor" class="col-sm-2 col-form-label">Nama Vendor</label>
			<div class="col-sm-3">
				<input type="hidden" class="form-control" id="KodeVendor" name="kode_vendor" value="<?php echo $UbahDataTrxPengadaanHardware["kode_vendor"]; ?>"/>
				<input type="text" class="form-control" id="NamaVendor" name="nama_vendor" placeholder="Nama Vendor" value="<?php echo $UbahDataTrxPengadaanHardware["nama_vendor"]; ?>" readonly/>
				<input type="hidden" class="form-control" id="Status" name="status" value="<?php echo $UbahDataTrxPengadaanHardware["status"]; ?>"/>
			</div>
			<div class="col-sm-1">
		...
		<div class="form-group row">
			...
			<div class="input-group col-sm-4">
				...
				<input type="number" class="form-control" id="HargaHardware" name="harga_hardware" autocomplete="off" maxlength="30" required oninvalid="this.setCustomValidity('Harga Hardware Harus Diisi.')" oninput="setCustomValidity('')" value="<?php echo $UbahDataTrxPengadaanHardware["harga_hardware"]; ?>"/>
			</div>
		</div>
		<div class="form-group row">
