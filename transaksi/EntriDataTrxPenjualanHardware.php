...
if (isset($_POST["TombolSimpan"])) {
	if (EntriDataTrxPenjualanHardware($_POST) > 0) {
		echo "
			<script>
...
$SQL		= "SELECT max(kode_penjualan_hardware) AS Kode FROM trx_penjualan_hardware";
...
<div class="container">
	<div id="JudulForm">
		<h2>Entri Data Penjualan Hardware</h2>
		<hr>
	</div>
</div>
...
<div class="container">
	<form action="" method="POST" id="FormEntri">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="KodePenjualan" name="kode_penjualan_hardware" value="<?php echo $KodeBaru ?>" readonly/>
			</div>
		</div>
		<div class="form-group row Tanggal">
			<label for="TanggalPenjualan" class="col-sm-2 col-form-label">Tanggal Penjualan</label>
			<div class="input-group col-sm-4">
				<input type="text" class="form-control" id="TanggalPenjualan" name="tanggal_penjualan_hardware" placeholder="YYYY-MM-DD" autocomplete="off" required oninvalid="this.setCustomValidity('Tanggal Penjualan Harus Diisi.')" oninput="setCustomValidity('')"/>
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<input type="hidden" class="form-control" id="KodePeremajaan" name="kode_peremajaan_hardware"/>
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<input type="hidden" class="form-control" id="KodePengepul" name="kode_pengepul"/>
				<input type="text" class="form-control" id="NamaPengepul" name="nama_pengepul" placeholder="Nama Pengepul" readonly/>
			</div>
			<div class="col-sm-1">
				<button type="button" id="TombolLookUpHardware" class="btn btn-outline-success" data-toggle="modal" data-target="#ModalPengepul">Cari</button>
			</div>
		</div>
		<div class="form-group row">
			<label for="HargaJualHardware" class="col-sm-2 col-form-label">Harga Jual Hardware</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="HargaJualHardware" name="harga_jual_hardware" placeholder="Harga Jual Hardware" autocomplete="off" required oninvalid="this.setCustomValidity('Harga Jual Hardware Harus Diisi.')" oninput="setCustomValidity('')"/>
			</div>
		</div>
		<div class="form-group row">
