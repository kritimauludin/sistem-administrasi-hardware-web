...
if (isset($_POST["TombolSimpan"])) {
	if (EntriDataTrxPerawatanHardware($_POST) > 0) {
		echo "
			<script>
...
$SQL		= "SELECT max(kode_perawatan_hardware) AS Kode FROM trx_perawatan_hardware";
...
<div class="container">
	<div id="JudulForm">
		<h2>Entri Data Perawatan Hardware</h2>
		<hr>
	</div>
</div>
...
<div class="container">
	<form action="" method="POST" id="FormEntri">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="KodePerawatan" name="kode_perawatan_hardware" value="<?php echo $KodeBaru ?>" readonly/>
			</div>
		</div>
		<div class="form-group row Tanggal">
			<label for="TanggalPerawatan" class="col-sm-2 col-form-label">Tanggal Perawatan</label>
			<div class="input-group col-sm-4">
				<input type="text" class="form-control" id="TanggalPerawatan" name="tanggal_perawatan_hardware" placeholder="YYYY-MM-DD" autocomplete="off" required oninvalid="this.setCustomValidity('Tanggal Perawatan Harus Diisi.')" oninput="setCustomValidity('')"/>
		...
		<div class="form-group row">
			...
			<div class="input-group col-sm-4">
				...
				<input type="number" class="form-control" id="BiayaPerawatan" name="biaya_perawatan" autocomplete="off" maxlength="30" required oninvalid="this.setCustomValidity('Biaya Perawatan Harus Diisi.')" oninput="setCustomValidity('')"/>
			</div>
		</div>
		<div class="form-group row">
			<label for="NamaPICIT" class="col-sm-2 col-form-label">Nama PIC IT</label>
			<div class="col-sm-3">
				<input type="hidden" class="form-control" id="KodePICIT" name="id"/>
				<input type="text" class="form-control" id="NamaPICIT" name="nama_pic_it" placeholder="Nama PIC IT" readonly/>
			</div>
			<div class="col-sm-1">
