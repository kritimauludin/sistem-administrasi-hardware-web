...
$SQL		= "SELECT max(kode_cabang) AS Kode FROM mst_cabang";
...
<div class="container">
	<div id="JudulForm">
		<h2>Entri Data Master Cabang</h2>
		<hr>
	</div>
</div>
...
<div class="container">
	<form action="" method="POST" id="FormEntri">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="KodeCabang" name="kode_cabang" value="<?php echo $KodeBaru ?>" readonly/>
			</div>
		</div>
		<div class="form-group row">
			<label for="NamaCabang" class="col-sm-3 col-form-label">Nama Cabang</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="NamaCabang" name="nama_cabang" placeholder="Masukan Nama Cabang" autocomplete="off" maxlength="50" required oninvalid="this.setCustomValidity('Nama Cabang Harus Diisi.')" oninput="setCustomValidity('')"/>
			</div>
		</div>
		<div class="form-group row">
			<label for="Alamat" class="col-sm-3 col-form-label">Alamat</label>
			<div class="col-sm-4">
				<textarea class="form-control" name="alamat" id="Alamat" cols="50" rows="4" maxlength="150" required oninvalid="this.setCustomValidity('Alamat Harus Diisi.')" oninput="setCustomValidity('')"></textarea>
			</div>
		</div>
		<div class="form-group row">
