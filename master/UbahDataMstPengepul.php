...
$UbahDataMstPengepul = Query("SELECT mst_pengepul.kode_pengepul, mst_pengepul.nama_pengepul, mst_pengepul.alamat, mst_propinsi.kode_propinsi, mst_propinsi.nama_propinsi, mst_kabupaten_kota.kode_kabupaten_kota, mst_kabupaten_kota.nama_kabupaten_kota, mst_pengepul.no_telepon
	FROM mst_pengepul
	INNER JOIN mst_propinsi ON mst_pengepul.kode_propinsi = mst_propinsi.kode_propinsi
	INNER JOIN mst_kabupaten_kota ON mst_pengepul.kode_kabupaten_kota = mst_kabupaten_kota.kode_kabupaten_kota
	WHERE kode_pengepul = '$KodePengepul'")[0];

if (isset($_POST["TombolUbah"])) {
	if (UbahDataMstPengepul($_POST) > 0) {
		echo "
			<script>
...
<div class="container">
	<div id="JudulForm">
		<h2>Ubah Data Master Pengepul</h2>
		<hr>
	</div>
</div>
...
<div class="container">
	<form action="" method="POST" id="FormEntri">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="KodePengepul" name="kode_pengepul" value="<?php echo $UbahDataMstPengepul["kode_pengepul"]; ?>" readonly/>
			</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<textarea class="form-control" name="alamat" id="Alamat" cols="50" rows="4" maxlength="100" required oninvalid="this.setCustomValidity('Alamat Harus Diisi.')" oninput="setCustomValidity('')"><?php echo $UbahDataMstPengepul["alamat"]; ?></textarea>
			</div>
		</div>
		<div class="form-group row">
			<label for="NamaPropinsi" class="col-sm-3 col-form-label">Nama Propinsi</label>
			<div class="col-sm-3">
				<input type="hidden" class="form-control" id="KodePropinsi" name="kode_propinsi" value="<?php echo $UbahDataMstPengepul["kode_propinsi"]; ?>"/>
				<input type="text" class="form-control" id="NamaPropinsi" name="nama_propinsi" placeholder="Nama Propinsi" value="<?php echo $UbahDataMstPengepul["nama_propinsi"]; ?>" readonly/>
			</div>
			<div class="col-sm-1">
		...
		<div class="form-group row">
			...
			<div class="col-sm-3">
				<input type="hidden" class="form-control" id="KodeKabupatenKota" name="kode_kabupaten_kota" value="<?php echo $UbahDataMstPengepul["kode_kabupaten_kota"]; ?>"/>
				<input type="text" class="form-control" id="NamaKabupatenKota" name="nama_kabupaten_kota" placeholder="Nama Kabupaten / Kota" value="<?php echo $UbahDataMstPengepul["nama_kabupaten_kota"]; ?>" readonly/>
			</div>
			<div class="col-sm-1">
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="NomorTelepon" name="no_telepon" placeholder="Masukan Nomor Telepon" autocomplete="off" pattern="^\d{0,13}$" title="Nomor Telepon Harus Menggunakan Angka & Tidak Boleh Lebih Dari 13 Digit." required oninvalid="this.setCustomValidity('Nomor Telepon Harus Diisi.')" oninput="setCustomValidity('')" value="<?php echo $UbahDataMstPengepul["no_telepon"]; ?>"/>
			</div>
		</div>
		<div class="form-group row">
