...
<div class="container">
	<div id="JudulForm">
		<h2>Entri Data Master PIC IT</h2>
		<hr>
	</div>
</div>
...
<div class="container">
	<form action="" method="POST" id="FormEntri">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="KodePIC" name="id" value="<?php echo $KodeBaru ?>" readonly/>
			</div>
		</div>
		<div class="form-group row">
			<label for="NamaPIC" class="col-sm-2 col-form-label">Nama PIC IT</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="NamaPIC" name="nama_pic_it" placeholder="Masukan Nama PIC" autocomplete="off" maxlength="150" required oninvalid="this.setCustomValidity('Nama PIC IT Harus Diisi.')" oninput="setCustomValidity('')"/>
			</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="email" class="form-control" id="AlamatEmail" name="alamat_email" placeholder="Masukan Alamat Email" autocomplete="off" maxlength="100" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="Format Email: contoh@email.com" required oninvalid="this.setCustomValidity('Alamat Email Harus Diisi.')" oninput="setCustomValidity('')"/>
			</div>
		</div>
		<div class="form-group row">
