...
if (isset($_POST["TombolSimpan"])) {
	if (EntriDataMstKabupatenKota($_POST) > 0) {
		echo "
			<script>
...
<div class="container">
	<div id="JudulForm">
		<h2>Entri Data Master Kabupaten / Kota</h2>
		<hr>
	</div>
</div>
...
<div class="container">
	<form action="" method="POST" id="FormEntri">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="KodeKabupatenKota" name="kode_kabupaten_kota" placeholder="Masukan Kode Kabupaten / Kota" autocomplete="off" maxlength="10" required oninvalid="this.setCustomValidity('Kode Kabupaten / Kota Harus Diisi.')" oninput="setCustomValidity('')"/>
			</div>
		</div>
		<div class="form-group row">
			<label for="NamaKabupatenKota" class="col-sm-3 col-form-label">Nama Kabupaten / Kota</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="NamaKabupatenKota" name="nama_kabupaten_kota" placeholder="Masukan Nama Kabupaten / Kota" autocomplete="off" maxlength="50" required oninvalid="this.setCustomValidity('Nama Kabupaten / Kota Harus Diisi.')" oninput="setCustomValidity('')"/>
			</div>
		</div>
		<div class="form-group row">
