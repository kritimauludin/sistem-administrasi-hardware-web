...
$SQL		= "SELECT max(kode_divisi) AS Kode FROM mst_divisi";
...
<div class="container">
	<div id="JudulForm">
		<h2>Entri Data Master Divisi</h2>
		<hr>
	</div>
</div>
...
<div class="container">
	<form action="" method="POST" id="FormEntri">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="KodeDivisi" name="kode_divisi" value="<?php echo $KodeBaru ?>" readonly/>
			</div>
		</div>
		<div class="form-group row">
			<label for="NamaDivisi" class="col-sm-2 col-form-label">Nama Divisi</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="NamaDivisi" name="nama_divisi" placeholder="Masukan Nama Divisi" autocomplete="off" maxlength="20" required oninvalid="this.setCustomValidity('Nama Dvisi Harus Diisi.')" oninput="setCustomValidity('')"/>
			</div>
		</div>
		<div class="form-group row">
