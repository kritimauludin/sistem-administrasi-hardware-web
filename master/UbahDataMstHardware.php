...
$UbahDataMstHardware = Query("SELECT mst_hardware.kode_hardware, mst_hardware.nama_hardware, mst_kategori.kode_kategori, mst_kategori.nama_kategori, mst_merk.kode_merk, mst_merk.nama_merk, mst_tipe.kode_tipe, mst_tipe.nama_tipe
	FROM mst_hardware
	INNER JOIN mst_kategori ON mst_hardware.kode_kategori = mst_kategori.kode_kategori
	INNER JOIN mst_merk ON mst_hardware.kode_merk = mst_merk.kode_merk
	INNER JOIN mst_tipe ON mst_hardware.kode_tipe = mst_tipe.kode_tipe
	WHERE kode_hardware = '$KodeHardware'")[0];

if (isset($_POST["TombolUbah"])) {
	if (UbahDataMstHardware($_POST) > 0) {
		echo "
			<script>
...
<div class="container">
	<div id="JudulForm">
		<h2>Ubah Data Master Hardware</h2>
		<hr>
	</div>
</div>
...
<div class="container">
	<form action="" method="POST" id="FormEntri">
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="KodeHardware" name="kode_hardware" value="<?php echo $UbahDataMstHardware["kode_hardware"]; ?>" readonly/>
			</div>
		</div>
		<div class="form-group row">
			<label for="NamaHardware" class="col-sm-2 col-form-label">Nama Hardware</label>
			<div class="col-sm-4">
				<input type="text" class="form-control" id="NamaHardware" name="nama_hardware" placeholder="Masukan Nama Hardware" autocomplete="off" maxlength="150" required oninvalid="this.setCustomValidity('Nama Hardware Harus Diisi.')" oninput="setCustomValidity('')" value="<?php echo $UbahDataMstHardware["nama_hardware"]; ?>"/>
			</div>
		</div>
		<div class="form-group row">
			<label for="NamaKategori" class="col-sm-2 col-form-label">Nama Kategori</label>
			<div class="col-sm-4">
				<input type="hidden" class="form-control" id="KodeKategori" name="kode_kategori" value="<?php echo $UbahDataMstHardware["kode_kategori"]; ?>"/>
				<input type="text" class="form-control" id="NamaKategori" name="nama_kategori" placeholder="Masukan Nama Kategori" value="<?php echo $UbahDataMstHardware["nama_kategori"]; ?>" readonly/>
			</div>
						<div class="col-sm-1">
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="hidden" class="form-control" id="KodeMerk" name="kode_merk" value="<?php echo $UbahDataMstHardware["kode_merk"]; ?>"/>
				<input type="text" class="form-control" id="NamaMerk" name="nama_merk" placeholder="Masukan Nama Merk" value="<?php echo $UbahDataMstHardware["nama_merk"]; ?>" readonly/>
			</div>
			<div class="col-sm-1">
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="hidden" class="form-control" id="KodeTipe" name="kode_tipe" value="<?php echo $UbahDataMstHardware["kode_tipe"]; ?>"/>
				<input type="text" class="form-control" id="NamaTipe" name="nama_tipe" placeholder="Masukan Nama Tipe" value="<?php echo $UbahDataMstHardware["nama_tipe"]; ?>" readonly/>
			</div>
			<div class="col-sm-1">
