...
<div class="container-fluid">
	<div id="JudulForm">
		<h2>Data Master Tipe Hardware</h2>
		<hr>
	</div>
</div>

<div class="container-fluid" id="TampilDataMasterTipe">
	<div class="container-fluid" id="TambahData">
		<a href="../master/EntriDataMstTipe.php"><button type="button" class=" btn btn-outline-success"><i class="fas fa-plus-circle"></i> Tambah Data
		</button></a>
	</div>
	<hr>
	<!-- Awal Tampil Data -->
	<table class="table table-hover" id="TabelTampilData">
		...
		<tr>
			<td align="center">
				<a href="UbahDataMstTipe.php?kode_tipe=<?php echo $Baris["kode_tipe"] ?>" data-toggle="tooltip" data-placement="bottom" title="Ubah Data"><i class="fas fa-edit"></i></a>
				<a href="HapusDataMstTipe.php?kode_tipe=<?php echo $Baris["kode_tipe"] ?>" data-toggle="tooltip" data-placement="bottom" title="Hapus Data" onclick="return confirm('Yakin Data Akan Dihapus?');"><i class="fas fa-trash"></i></a>
			</td>
