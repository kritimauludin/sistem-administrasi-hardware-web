...
<div class="container-fluid" align="center">
	<div id="JudulForm">
		...
		<h2>Laporan Peremajaan Hardware IT</h2>
		<hr>
	</div>
</div>
...
<div class="container-fluid">
	<form method="GET" id="FormLaporan">
		...
		<div class="form-row">
			<div class="form-group col-sm-3 FormTahun">
				...
				<select class="form-control" name="filter_tahun" id="PilihTahun">
	                <option value="">Pilihan</option>
	                <?php
	                	$Query = "SELECT YEAR(tanggal_peremajaan_hardware) AS filter_tahun FROM trx_peremajaan_hardware GROUP BY YEAR(tanggal_peremajaan_hardware)";
		...
		<div class="form-row">
			<div class="form-group col-sm-3">
				...
				<a href="FormLaporanDataPeremajaanHardware.php"><button type="button" id="TombolReset" class="btn btn-outline-danger">Reset</button></a>
			</div>
		</div>
	</form>
	<div>
	...
	if (isset($_GET['Filter']) && ! empty($_GET['Filter'])) {
		...
		if ($FilterData == '1') {
			...
			echo '<hr>';
			echo 'Data Transaksi Peremajaan Hardware Tanggal <i style="color: #e74c3c;">'.$FilterDataTanggal.'</i> ';
			echo '<a href="CetakLaporanDataPeremajaanHardware.php?Filter=1&filter_tanggal='.$_GET['filter_tanggal'].'" class="text-success"><i class="fas fa-file-pdf"></i> Cetak ke PDF</a></br>';
			...
			echo '<hr>';
			echo 'Data Transaksi Peremajaan Hardware Bulan <i style="color: #e74c3c;">'.$FilterDataBulan[$_GET['filter_bulan']].' '.$_GET['filter_tahun'].' </i>';
			echo '<a href="CetakLaporanDataPeremajaanHardware.php?Filter=2&filter_bulan='.$_GET['filter_bulan'].'&filter_tahun='.$_GET['filter_tahun'].'" class="text-success"><i class="fas fa-file-pdf"></i> Cetak ke PDF</a></br>';
			...
			echo '<hr>';
			echo 'Data Transaksi Peremajaan Hardware Tahun <i style="color: #e74c3c;">'.$_GET['filter_tahun'].'</i> ';
	        echo '<a href="CetakLaporanDataPeremajaanHardware.php?Filter=3&filter_tahun='.$_GET['filter_tahun'].'" class="text-success"><i class="fas fa-file-pdf"></i> Cetak PDF</a></br>';
			...
			echo '<hr>';
			echo 'Data Transaksi Peremajaan Hardware Cabang <i style="color: #e74c3c;">'.$_GET['nama_cabang'].'</i> ';
	        echo '<a href="CetakLaporanDataPeremajaanHardware.php?Filter=4&kode_cabang='.$_GET['kode_cabang'].'&nama_cabang='.$_GET['nama_cabang'].'" class="text-success"><i class="fas fa-file-pdf"></i> Cetak ke PDF</a></br>';
		...
		echo '<hr>';
		echo '<i style="color: #e74c3c;">Semua Data Transaksi Peremajaan Hardware</i> ';
	    echo '<a href="CetakLaporanDataPeremajaanHardware.php" class="text-success"><i class="fas fa-file-pdf"></i> Cetak ke PDF</a></br>';
